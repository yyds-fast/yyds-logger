...
class Core:
    def __init__(self):
        ...
        self.context = ContextVar("loguru_context", default={})
...
class Logger:
    ...
    def contextualize(__self, **kwargs):  # noqa: N805
        ...
        **kwargs
        ...
        with __self._core.lock:
            new_context = {**__self._core.context.get(), **kwargs}
            token = __self._core.context.set(new_context)

        try:
            yield
        finally:
            with __self._core.lock:
                __self._core.context.reset(token)
    ...
    def _log(self, level, from_decorator, options, message, args, kwargs):
        ...
        log_record = {
            "elapsed": elapsed,
            "exception": exception,
            "extra": {**core.extra, **core.context.get(), **extra},
